...
## Environments
- Preview: https://main--eds-aem-based--Ashwitha2620.aem.page/
- Live: https://main--eds-aem-based--Ashwitha2620.aem.live/
...
1. Open the `eds-aem-based` directory in your favorite IDE and start coding :)
